  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between">
        <Link to="/sales" className="p-2 bg-white hover:bg-slate-100 border border-slate-300 text-slate-600 rounded-xl transition-colors inline-flex items-center gap-2 text-sm font-semibold shadow-sm">
