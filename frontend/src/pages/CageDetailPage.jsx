...
import { Building2, ArrowLeft, MapPin, Eye, ShoppingCart } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center gap-3">
        <Link to="/cages" className="p-2 bg-white hover:bg-slate-100 border border-slate-300 text-slate-600 rounded-xl transition-colors shadow-sm">
