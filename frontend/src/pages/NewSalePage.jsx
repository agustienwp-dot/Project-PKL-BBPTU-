  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center gap-3">
        <Link to="/sales" className="p-2 bg-white hover:bg-slate-100 border border-slate-300 text-slate-600 rounded-xl transition-colors shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 space-y-6 shadow-sm">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center border-b border-slate-200 pb-2">
            ...
            <Link to="/buyers" target="_blank" className="text-xs text-[#1E3F20] hover:underline font-bold">+ Tambah Pembeli Baru</Link>
          </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
          <Link to="/sales" className="px-5 py-2.5 text-sm font-bold text-slate-600 hover:text-slate-900 bg-slate-100 rounded-xl">
            Batal
          </Link>
