...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] text-slate-800 flex flex-col md:flex-row font-['Plus_Jakarta_Sans',sans-serif]">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 flex items-center gap-3 border-b border-white/10">
            ...
            <div>
              ...
              <span className="text-[11px] text-[#eaeae3] font-semibold tracking-wide">Sistem Ternak</span>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#F5F5F0]">
        ...
        <header className="hidden md:flex items-center justify-between px-8 py-4 bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
          <div className="flex items-center gap-2">
            <h1 className="text-sm font-bold text-[#1E3F20]">Sistem Manajemen Ternak & Penjualan</h1>
          </div>
