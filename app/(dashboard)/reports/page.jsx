        ...
        <table border="1" style="border-collapse:collapse; text-align:center;">
          <thead>
            <tr style="background-color:#e2e8f0; font-weight:bold;">
              ...
              <th colspan="12" style="background-color:#dcfce7;">PENERIMAAN / PRODUKSI</th>
              <th rowspan="2" style="background-color:#cbd5e1;">JUMLAH SUSU</th>
            </tr>
            <tr style="background-color:#f1f5f9; font-weight:bold;">
              <th colspan="3" style="background-color:#fef3c7;">FARM TEGALSARI</th>
              <th colspan="3" style="background-color:#e0f2fe;">FARM LIMPAKUWUS</th>
              <th colspan="3" style="background-color:#f3e8ff;">FARM MANGGALA</th>
              <th colspan="3" style="background-color:#dcfce7;">EDUWISATA</th>
            </tr>
            <tr style="background-color:#e2e8f0; font-weight:bold;">
            ...
            <table className="w-full text-center text-[11px] border-collapse border border-slate-300 print:border-black font-mono">
              <thead>
                ...
                <tr className="bg-slate-100 text-slate-900 font-extrabold uppercase print:bg-slate-200">
                  ...
                  <th colSpan={12} className="border border-slate-300 print:border-black px-2 py-1.5 font-sans">PENERIMAAN</th>
              ...
              <tbody className="divide-y divide-slate-200 print:divide-black text-slate-800">
                {dailyLogs.map((log) => {
                  ...
                  return (
                    <tr key={log.day} className={`hover:bg-amber-50/40 transition-colors ${fb.grandTotal > 0 ? 'bg-emerald-50/10' : ''}`}>
                      ...
                      {/* Grand Total Day */}
                      <td className="border border-slate-300 print:border-black px-1.5 py-1 text-right font-black text-emerald-800 bg-emerald-50/60">{fmt(fb.grandTotal)}</td>
                    </tr>
                  );
                })}
              </tbody>
                ...
                return (
                  <tfoot>
                    <tr className="bg-slate-200 font-extrabold text-slate-900 print:bg-slate-300 border-t-2 border-slate-400">
                      ...
                      {/* Grand Total */}
                      <td className="border border-slate-300 print:border-black px-2 py-2 text-right font-black text-sm text-emerald-950 bg-emerald-200">{fmtGrand(fmtMonthly.grandTotal)}</td>
                    </tr>
                  </tfoot>
                );
              })()}
