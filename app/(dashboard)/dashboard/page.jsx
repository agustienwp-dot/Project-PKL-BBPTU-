    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-6 space-y-4 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <Link href="/cages" className="text-xs font-bold text-[#1E3F20] hover:underline flex items-center gap-1">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-4 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <Link href="/sales" className="text-xs font-bold text-[#1E3F20] hover:underline flex items-center gap-1">
