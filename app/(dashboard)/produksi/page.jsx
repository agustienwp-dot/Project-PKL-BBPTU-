              ...
              <form onSubmit={handlePromptSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 rounded-xl border text-xs font-semibold outline-none transition-all ${
                      formErrors.formDate ? 'border-red-500 ring-2 ring-red-200 bg-red-50/50' : 'border-slate-300 focus:ring-2 focus:ring-emerald-500'
                    }`}
                    required
                  />
                  ...
                  {formAnimalType !== 'KAMBING' && (
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 rounded-xl border text-xs font-extrabold text-slate-800 focus:ring-2 focus:ring-emerald-500 outline-none bg-white transition-all ${
                          formErrors.formFarmOrigin ? 'border-red-500 ring-2 ring-red-200 bg-red-50/50' : 'border-slate-300'
                        }`}
                        required
                      >
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 rounded-xl border text-xs font-semibold outline-none font-mono [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none transition-all ${
                      formErrors.formGrossLiters ? 'border-red-500 ring-2 ring-red-200 bg-red-50/50' : 'border-slate-300 focus:ring-2 focus:ring-emerald-500'
                    }`}
                    required
                  />
                ...
                <div className="space-y-2 pt-2 border-t border-slate-200">
                  ...
                  {formFotoTimbangan ? (
                    ...
                    <label
                      ...
                      className={`group border-2 border-dashed rounded-2xl p-4 flex flex-col items-center justify-center gap-2 text-center cursor-pointer transition-all duration-200 ${
                        formErrors.formFotoTimbangan
